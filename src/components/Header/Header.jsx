    ...
    <>
      <header className="flex h-[4.875rem] w-full bg-sanaviye items-center justify-center fixed z-50 ">
        <nav className="flex flex-row items-center justify-between w-[85%] h-full tablet:w-[85%] transition ease-in-out delay-100 max-desktop:justify-between">
          <RxHamburgerMenu
            onClick={changeClose}
            className={`text-[26px] desktop:hidden  max-desktop:order-1 ${Ham}`}
          />

          <AiOutlineClose
            onClick={changeClose2}
            className={`text-[26px] text-black desktop:hidden  ${Close}`}
          />

          <img
            className="h-[36px] max-desktop:order-3 max-desktop:ml-[10%]"
            src={Logo}
            alt=""
          />
          ...
          <div className="w-[15%] h-full  max-desktopl:w-[20%]  max-desktop:order-4 max-mtablet:w-[50%] max-mtablet:h-[60%] ">
            <div className="w-full h-[50%]  flex items-center justify-around  ">
              ...
              <a
                ...
                className="flex flex-row-reverse max-mtablet:text-[12px]"
              >
                ۷۱۰ ۱۰ ۹۱۰ ۰۲۶
              </a>
            </div>
      ...
      <div
        className={`mtablet:h-[45vh] mobile:h-[47vh] bg-white w-full h-[48%] z-40 hidden max-desktop:block rounded-[5px]  ${Dur} ${Top}`}
      >
        <ul className="mtablet:pt-[12%] mobile:pt-[18%] pt-[25%] w-full h-full items-center  pr-[7%]  ">
          ...
          <li
            onClick={Arrow}
            className="flex items-center w-[25%] mt-[16px] hover:text-avaliye hover:border-b-[2px] hover:border-avaliye hover:transition ease-in-out delay-100"
          >
            <Link>خدمات ما</Link>

            <IoIosArrowDown
              onClick={changrotate}
              className={`mr-[10%] ${rotate}`}
            />
            <IoIosArrowUp
              onClick={changerotate2}
              className={`mr-[10%] ${rotateu}`}
            />
          </li>
